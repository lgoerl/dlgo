import random
from dlgo.nn.fromscratch.layers import DenseLayer, ActivationLayer
from dlgo.nn.fromscratch.loss import MSE
  ...
  def train(
    ...
    for epoch in range(epochs):
      ...
      if test_data:
        ...
        print("Epoch %s: %s/%s" % (epoch, self.evaluate(test_data), n_test))
      else: print("Epoch %s complete." % epoch)
