import numpy as np
from dlgo.nn.activation import sigmoid, sigmoid_prime
...
class ActivationLayer(Layer):
  ...
  def describe(self):
    ...
    print("  |-- dimensions: (%s, %s)" % self.input_dim, self.output_dim)
...
class DenseLayer(Layer):
  ...
  def backward(self):
    ...
    self.output_delta = np.dot(self.weight.transpost(), delta)
